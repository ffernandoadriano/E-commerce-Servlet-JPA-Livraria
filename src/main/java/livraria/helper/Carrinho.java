...
public class Carrinho {
	...
	// As duas coleções são gerenciadas simultaneamente. Uma tem objetos view, e a
	// outra objetos entity.
	// Ambas são Set, para evitar que livros iguais possam ser adicionados mais de
	// uma vez no carrinho.
