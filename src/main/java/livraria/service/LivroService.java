...
public class LivroService extends Service {
	...
	public List<Livro> pesquisarLivros(String titulo, String autor) throws ServiceException {
		try {
			...
			// Os livros são colocados em um Set para evitar que existam resultados
			// duplicados na pesquisa
	 ...
	 * @throws ServiceException
	 */
	public Livro getLivroById(Integer livroId) throws ServiceException {
		try {
