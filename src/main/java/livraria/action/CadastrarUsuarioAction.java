...
public class CadastrarUsuarioAction extends Action {
	...
	public void process() throws Exception {
		...
		if (email == null) {
			// Se o parâmetro 'email' não existe é porque o usuário abriu a tela para
		...
		if (!sucesso) {
			// O usuário já existe. Recoloca os valores na request e volta para a própria
			// tela
